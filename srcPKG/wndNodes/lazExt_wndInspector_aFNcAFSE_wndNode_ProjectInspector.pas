...
type
 ...
 tLazExt_wndInspector_aFNcAFSE_wndNode_ProjectInspector=class(tLazExt_wndInspector_aFNcAFSE_wndNode)
  public
...
class function tLazExt_wndInspector_aFNcAFSE_wndNode_ProjectInspector.OfMyType(const testForm:TCustomForm):boolean;
begin
